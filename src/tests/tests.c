...
START_TEST(s21_create_matrix_2) {
  ck_assert_int_eq(s21_create_matrix(5, 5, NULL), INCORRECT_MATRIX_ERROR);
}
END_TEST

START_TEST(s21_create_matrix_3) {
  matrix_t A = {};
  ck_assert_int_eq(s21_create_matrix(5, 0, &A), INCORRECT_MATRIX_ERROR);
}
END_TEST
...
START_TEST(s21_mult_matrix_1) {
  ...
  s21_create_matrix(3, 3, &A);
  fill_matrix(&A, 1, 1);
  ck_assert_int_eq(s21_mult_matrix(&A, NULL, NULL), INCORRECT_MATRIX_ERROR);
  s21_remove_matrix(&A);
}
END_TEST
...
START_TEST(s21_determinant_1) {
  matrix_t A = {};
  double det = 0;
  ck_assert_int_eq(s21_determinant(&A, &det), INCORRECT_MATRIX_ERROR);
}
END_TEST
...
START_TEST(s21_inverse_matrix_1) {
  matrix_t A = {};
  matrix_t result = {};
  ck_assert_int_eq(s21_inverse_matrix(&A, &result), INCORRECT_MATRIX_ERROR);
}
END_TEST
